...
class configPara:
    def __init__(self, config_file, env_file):
        ...
        self.bcd_num_restarts = 0       # BCD 多起点重启次数：0 = 不重启
...
"""
    ...
    def getConfigInfo(self):
        ...
        self.bcd_num_restarts = self.get_config_value('edgeUavBCDIntegration', 'bcd_num_restarts', self.bcd_num_restarts, cast=int)
