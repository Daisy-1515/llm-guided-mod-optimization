...
**所有项目文档统一管理在 `文档/` 目录中。详见 [`文档/INDEX.md`](文档/INDEX.md) 以获取完整的文档索引和快速查找指南。**

常用文档（快速链接）：
- **数学模型**: [`公式.md`](文档/10_模型与公式/公式.md)（完整定义）、[`公式20_凸性分析.md`](文档/10_模型与公式/公式20_凸性分析.md)
- **系统设计**: [`场景生成器设计方案.md`](文档/场景生成器设计方案.md)
- **Phase⑥ 计划**: [`plans/phase6-step3-socp-fix-plan.md`](plans/phase6-step3-socp-fix-plan.md)
- **诊断报告**: [`Phase5_LLM调用问题诊断报告.md`](文档/40_审查与诊断/Phase5_LLM调用问题诊断报告.md)
- **工作日记**: [`文档/70_工作日记/`](文档/70_工作日记/)（按日期，由 `/endday` 自动生成）
