...
2. 资源分配变量：
   ...
   维度上，$f_i^t$ 的规模为 $|\mathcal{I}|\times|\mathcal{T}|$，$f_{j,i}^t$ 的规模为 $|\mathcal{J}|\times|\mathcal{I}|\times|\mathcal{T}|$。
...
flowchart LR
    ...
    subgraph INPUT["输入层"]
        ...
        Z["UAV 轨迹<br/>q<sub>j</sub><sup>t</sup>, v<sub>j</sub><sup>t</sup>"]
    end
    ...
    subgraph UAV["UAV 能耗与轨迹"]
        direction TB
        H["轨迹约束  (4a)-(4f)<br/>q<sub>j</sub><sup>t+1</sup> = q<sub>j</sub><sup>t</sup>+v<sub>j</sub><sup>t</sup>δ"]
